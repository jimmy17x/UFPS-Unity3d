...
public class CODGhostEffect : MonoBehaviour
{
	...
	public void showPopUp(){
		StartCoroutine(CODGhostCollectibleEffect(textToAnimate, imageToAnimate));
	}

	
	private IEnumerator CODGhostCollectibleEffect(Text text, Image image)
	{
		Debug.Log ("pop cod ghost texture");
